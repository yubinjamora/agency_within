$(document).ready(function() {
    ...
    $.ajax({
        url: "https://api.openweathermap.org/data/2.5/weather?q=New+York&units=imperial&appid=" + APIKey,
        method: "GET"
...
$(document).ready(function() {
    ...
    // Iterate cityName into new URL
        ...
        $.ajax({
            url: "https://api.openweathermap.org/data/2.5/forecast?id=5128638&units=imperial&appid=" + APIKey,
            method: "GET"
            // We store all of the retrieved data inside of an object called "response"
        }).done(function(response) {
